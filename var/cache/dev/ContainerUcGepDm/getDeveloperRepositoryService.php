 ...
 */
class getDeveloperRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DeveloperRepository' shared autowired service.
     *
     * @return \App\Repository\DeveloperRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DeveloperRepository.php';

        return $container->privates['App\\Repository\\DeveloperRepository'] = new \App\Repository\DeveloperRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
